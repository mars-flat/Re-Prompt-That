...
if (!hasOpenAIKey) {
  logMessage(Events.initializing, '⚠️  Warning: OPENAI_API_KEY not found. AI features will be disabled.');
}
...
async function initializeServer() {
  try {
    ...
    logError(Events.initializing, 'Failed to initialize pipeline. Server will continue without vector similarity:', error);
  }
}
